...
dari folder ‘data-raw’ sebagai berikut: Penggunaan alamat relatif,
karena itu naik 2 level di folder intro yang sama :
“../data-raw/evals.csv” Ada 463 baris dan 21 kolom
...
Glimpse menampilkan kolom2 sesuai urutan dalam file beserta isi kolomnya
dari baris pertama.

Skim menampilkan lebih banyak informasinya dengan cara mengelompokkan
kolom2 untuk kategori character, number, dsb.
...
Terbentuk evals3 namun cuma terdapat di sistem dimana secara fisik belum
ada.
...
menjelaskan alasan mengapa beberapa dataset berikut tidak *tidy*? Table
1 tidy data Table 2 bukan tidy data, karena case dan population yang
mestinya kolom dijadikan observasi. Table3 bukan tidy data, karena kolom
terakhir yg mestinya hasil pembagian tapi bertipe char Table4a bukan
tidy data, yg seharusnya observasi disimpan sebagai kolom Table4b bukan
tidy data, sama dengan 4b, kita ga tahu mana cases mana population
Table5 bukan tidy data, karena dipisah antara century dan year, selain
itu nilai 2 kolom digabungkan jadi 1 kolom
