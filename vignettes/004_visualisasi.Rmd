...
Untuk melihat distribusi data, Misalkan dengan histogram, dengan range=5, terlihat kalau distribusi data cukup normal.
...
Dengan kata lain, membuat model dalam grafik.
Metodenya bisa macam-macam, bisa pakai lm.
